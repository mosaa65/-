...
## 🔶 سؤال 6: عيوب قاعدة البيانات العلائقية؟

<table>
<tr><td>📝 <b>الشرح</b></td></tr>
<tr><td>حسب النص الذي أرسلته من المقرر، هذه أهم عيوب قواعد البيانات العلائقية.</td></tr>
</table>

**⚠️ العيوب الرئيسية (حسب النص)**:
...
**تفاصيل مرتبطة بالبيانات الضخمة (حسب النص)**:
...
📖 **المصدر**: قسم Relational Database Disadvantages من المقرر (النص الذي أرسلته)

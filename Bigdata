...
<table>
<tr><td>📝 <b>الشرح</b></td></tr>
<tr><td>رغم قوة قواعد البيانات العلائقية، إلا أن لها قيود عند التعامل مع البيانات الضخمة.</td></tr>
</table>
...
| العيب | التفصيل |
|-------|---------|
| ❌ صعوبة التعامل مع البيانات الضخمة | Handling Big Data |
| ❌ اختناقات الأداء | Performance Bottlenecks |
| ❌ تكلفة عالية عند التوسع الرأسي | Scale Up Cost |
| ❌ صعوبة مع البيانات غير المنظمة | Unstructured Data |
| ❌ تعقيد البيئات الموزعة | Distributed Environments |
...
| المعيار | 🔵 RDBMS | 🟠 Big Data |
|---------|----------|-------------|
| **الحجم** | GB/TB | PB/ZB |
| **التنظيم** | مركزي (Centralized) | موزع (Distributed) |
| **نوع البيانات** | منظمة فقط | منظمة/شبه/غير منظمة |
| **العتاد** | خوادم عالية | أجهزة سلع (Commodity) |
| **التحديثات** | قراءة/كتابة متكررة | كتابة مرة وقراءة مرات |
| **المخطط** | ثابت | مرن/ديناميكي |
